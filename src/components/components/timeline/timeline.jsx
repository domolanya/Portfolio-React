        ...
        return (
          ...
          <p className="headline">Working experience</p>
                  <div className="timeline-entry">
                    <Card expanded={this.state.expanded1} onExpandChange1={this.handleExpandChange1}>
                        ...
                        <CardText expandable={true}>
                          ...
                          <p>Took part in showcasing prototypes for Applied Technology Innovation and Strategy team.</p>                            <br/><br/>
                  ...
                  <div className="timeline-entry">
                  <Card expanded={this.state.expanded2} onExpandChange2={this.handleExpandChange2}>
                ...
                <div className="timeline-entry">
                  <Card expanded={this.state.expanded3} onExpandChange3={this.handleExpandChange3}>
                ...
                <div className="timeline-entry">
                  <Card expanded={this.state.expanded4} onExpandChange4={this.handleExpandChange4}>
